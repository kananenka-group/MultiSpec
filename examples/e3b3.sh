...
$srcdir/water/water_gen --xtc $tstdir/traj.xtc  --gro_file $tstdir/confout.gro --atoms_file q.inp --stretch_map gruenbaum_2013_tip4p  --IR 1 --Raman 1 --nframes $frames   --spec_type wsOH --water_model e3b3
