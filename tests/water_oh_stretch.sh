...
$srcdir/exciton/excp --dt 0.01  --tc 1.5  --H Hamiltonian.bin  --P Polarizability.bin  --IR 0 --Raman 1  --nframes $frames  --nchrom 1000  --T1 0.26  --navg $stat  --tsep 2.0 --w_avg 3415.2
